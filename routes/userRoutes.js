...
const {registerSuperAdminWithRestaurant, register, registerAdmin, login, createRole, getRoles, getPermissions, getUsers, logout } = require('../controller/userController');
